class EditionsController < ApplicationController
  ...
  def create
    ...
    @grandslam = Grandslam.find(params[:grandslam_id])
    @edition = @grandslam.editions.create(params[:edition])

    respond_to do |format|
      if @edition.save
        format.html { redirect_to @grandslam, notice: 'Edition was successfully created.' }
